...
var require_stylis_min = __commonJS({
  "node_modules/better-react-carousel/node_modules/stylis/stylis.min.js"(exports, module) {
    !function(e) {
...
var require_stylis_rule_sheet = __commonJS({
  "node_modules/better-react-carousel/node_modules/stylis-rule-sheet/index.js"(exports, module) {
    (function(factory) {
...
// node_modules/better-react-carousel/node_modules/@emotion/unitless/dist/unitless.browser.esm.js
...
// node_modules/better-react-carousel/node_modules/@emotion/memoize/dist/memoize.browser.esm.js
function memoize(fn) {
  var cache = {};
  return function(arg) {
...
// node_modules/better-react-carousel/node_modules/@emotion/is-prop-valid/dist/is-prop-valid.browser.esm.js
...
// node_modules/better-react-carousel/node_modules/styled-components/dist/styled-components.browser.esm.js
...
var require_bundle = __commonJS({
  "node_modules/better-react-carousel/dist/bundle.js"(exports, module) {
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
    }
    var React2 = require_react();
    var React__default = _interopDefault(React2);
    var styled3 = _interopDefault((init_styled_components_browser_esm(), __toCommonJS(styled_components_browser_esm_exports)));
    ...
    var ButtonWrapper = styled3.div.withConfig({
    ...
    var Button = styled3.span.withConfig({
    ...
    ArrowButton.propTypes = {
      type: PropTypes2.oneOf(["prev", "next"]).isRequired,
      mobileBreakpoint: PropTypes2.number,
      hidden: PropTypes2.bool,
      CustomBtn: PropTypes2.oneOfType([PropTypes2.node, PropTypes2.element, PropTypes2.elementType]),
      onClick: PropTypes2.func.isRequired
    };
    var DotWrapper = styled3.div.withConfig({
      displayName: "Dot__DotWrapper",
      componentId: "sc-176tc56-0"
    })(["display:flex;margin:0 5px;cursor:pointer;"]);
    var DotDefault = styled3.div.withConfig({
    ...
    var Dot = function Dot2(_ref2) {
      var index2 = _ref2.index, _ref2$isActive = _ref2.isActive, isActive = _ref2$isActive === void 0 ? false : _ref2$isActive, dotColorInactive = _ref2.dotColorInactive, dotColorActive = _ref2.dotColorActive, DotCustom = _ref2.dot, onClick = _ref2.onClick;
      var handleClick = React2.useCallback(function() {
        onClick(index2);
      }, [index2, onClick]);
    ...
    Dot.propTypes = {
      index: PropTypes2.number.isRequired,
      isActive: PropTypes2.bool,
      dotColorInactive: PropTypes2.string,
      dotColorActive: PropTypes2.string,
      dot: PropTypes2.oneOfType([PropTypes2.node, PropTypes2.element, PropTypes2.elementType]),
      onClick: PropTypes2.func.isRequired
    };
    ...
    var addResizeHandler = function addResizeHandler2(key, handler) {
      if (_typeof2(window[HANDLER_NAME_SPACE]) !== "object") {
    ...
    var useResponsiveLayout = function useResponsiveLayout2() {
      ...
      var _useState = React2.useState(), _useState2 = _slicedToArray(_useState, 2), currentBreakpointSetting = _useState2[0], setCurrentBreakpointSetting = _useState2[1];
      var random = React2.useMemo(function() {
        return "".concat(Math.random(), "-").concat(Math.random());
      }, []);
      var sortedBreakpointList = React2.useMemo(function() {
        return _toConsumableArray(breakpointList).sort(function(a, b) {
          return (b.breakpoint || 0) - (a.breakpoint || 0);
        });
      }, [breakpointList]);
      var handleResize2 = React2.useCallback(function() {
    ...
    var Container = styled3.div.withConfig({
      displayName: "Carousel__Container",
      componentId: "sc-hyhecw-0"
    })(["position:relative;"]);
    var RailWrapper = styled3.div.withConfig({
    ...
    var Rail = styled3.div.withConfig({
    ...
    var ItemSet = styled3.div.withConfig({
      displayName: "Carousel__ItemSet",
      componentId: "sc-hyhecw-3"
    })(
      ["display:grid;grid-template-columns:", ";grid-template-rows:", ";grid-gap:", ";@media screen and (max-width:", "px){grid-template-columns:", ";grid-template-rows:1fr;&:last-of-type > ", ":last-of-type{padding-right:", ";margin-right:", ";}}"],
      function(_ref11) {
    ...
    var Dots = styled3.div.withConfig({
    ...
    var Item = styled3.div.withConfig({
    ...
    var Carousel = function Carousel2(_ref20) {
      ...
      var _useState = React2.useState(0), _useState2 = _slicedToArray(_useState, 2), currentPage = _useState2[0], setCurrentPage = _useState2[1];
      var _useState3 = React2.useState(false), _useState4 = _slicedToArray(_useState3, 2), isHover = _useState4[0], setIsHover = _useState4[1];
      var _useState5 = React2.useState(false), _useState6 = _slicedToArray(_useState5, 2), isTouch = _useState6[0], setIsTouch = _useState6[1];
      var _useState7 = React2.useState(colsProp), _useState8 = _slicedToArray(_useState7, 2), cols = _useState8[0], setCols = _useState8[1];
      var _useState9 = React2.useState(rowsProp), _useState10 = _slicedToArray(_useState9, 2), rows = _useState10[0], setRows = _useState10[1];
      var _useState11 = React2.useState(0), _useState12 = _slicedToArray(_useState11, 2), gap = _useState12[0], setGap = _useState12[1];
      var _useState13 = React2.useState(loopProp), _useState14 = _slicedToArray(_useState13, 2), loop = _useState14[0], setLoop = _useState14[1];
      var _useState15 = React2.useState(autoplayProp), _useState16 = _slicedToArray(_useState15, 2), autoplay = _useState16[0], setAutoplay = _useState16[1];
      var _useState17 = React2.useState(0), _useState18 = _slicedToArray(_useState17, 2), railWrapperWidth = _useState18[0], setRailWrapperWidth = _useState18[1];
      var _useState19 = React2.useState(false), _useState20 = _slicedToArray(_useState19, 2), hasSetResizeHandler = _useState20[0], setHasSetResizeHandler = _useState20[1];
      var railWrapperRef = React2.useRef(null);
      var autoplayIntervalRef = React2.useRef(null);
      var breakpointSetting = useResponsiveLayout(responsiveLayout);
      var randomKey = React2.useMemo(function() {
        return "".concat(Math.random(), "-").concat(Math.random());
      }, []);
      React2.useEffect(function() {
      ...
      var handleRailWrapperResize = React2.useCallback(function() {
        railWrapperRef.current && setRailWrapperWidth(railWrapperRef.current.offsetWidth);
      }, [railWrapperRef]);
      var setResizeHandler = React2.useCallback(function() {
      ...
      var rmResizeHandler = React2.useCallback(function() {
        removeResizeHandler("gapCalculator-".concat(randomKey));
        setHasSetResizeHandler(false);
      }, [randomKey]);
      var parseGap = React2.useCallback(function(gap2) {
        var parsed = gap2;
      ...
      var itemList = React2.useMemo(function() {
      ...
      var itemSetList = React2.useMemo(function() {
      ...
      var handlePrev = React2.useCallback(function() {
      ...
      var handleNext = React2.useCallback(function() {
      ...
      var startAutoplayInterval = React2.useCallback(function() {
      ...
      var turnToPage = React2.useCallback(function(page2) {
        setCurrentPage(page2);
      }, []);
      var handleHover = React2.useCallback(function() {
        setIsHover(function(hover) {
          return !hover;
        });
      }, []);
      var handleTouch = React2.useCallback(function() {
...
merge-anything/dist/index.esm.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=better-react-carousel.js.map
